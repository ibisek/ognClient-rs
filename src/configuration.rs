...
pub const DEFAULT_APRS_FILTER: &str = "r/49.3678/16.1144/9999999";

pub const AIRCRAFT_REGEX1: &str = "^([A-Z]{3})(.{6}).+?/([0-9]{6})h([0-9.]+?)([NS]).([0-9.]+?)([EW])(.{1})(\\d{3})/(\\d{3})/A=([-0-9]+).+?id(.{2})(.{6}).([+-0123456789]+?)fpm";
pub const AIRCRAFT_REGEX2: &str = "^([A-Z]{3})(.{6}).+?/([0-9]{6})h([0-9.]+?)([NS]).([0-9.]+?)([EW])(.{1})(\\d{3})/(\\d{3})/A=([-0-9]+).+?id(.{2})(.{6}).([+-0123456789]+?)fpm.([+-0123456789]+?)rot";
